    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            <div className="relative h-48 -mx-6 -mt-6 mb-6 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-[#4f46e5] via-[#6366f1] to-[#8b5cf6]"></div>
                ...
                <div className="relative h-full flex flex-col items-center justify-center text-white px-6">
                    ...
                    <p className="text-white/80 text-sm mt-1">Sign in to continue making a difference</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4 px-6">
                {error && (
                    <div className="flex items-center gap-2 p-3 bg-[var(--error-light)] border border-[var(--error)]/20 rounded-xl text-sm text-[var(--error)]">
                ...
                <div className="flex flex-col gap-1.5">
                    ...
                    <div className="relative">
                        <span className="absolute left-4 top-1/2 -translate-y-1/2 text-[var(--foreground-light)]">
            ...
            <div className="flex items-center gap-4 px-6 mt-6">
                ...
                <span className="text-xs text-[var(--foreground-light)] uppercase tracking-wider">or</span>
                <div className="flex-1 h-px bg-[var(--border)]"></div>
            </div>
            ...
            {/* Sign Up Link */}
            <div className="flex-1 flex items-end justify-center pb-8 mt-6">
